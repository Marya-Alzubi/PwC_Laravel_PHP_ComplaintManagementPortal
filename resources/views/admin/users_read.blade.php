...
@section('main')
    ...
    <div class="content-wrapper">
        <div class="content-body">
            <a href="{{route('users.create')}}"><button type="button" class="btn btn-primary glow mr-1 mb-1"><i class="bx bx-plus"></i>
                    <span class="align-middle ml-25">Add New User </span></button></a>
            <!-- table success start -->
